...
-- Assignment 2, Task 2
-- Code to recreate all the Database.
...
-- Prompt 4 of Assigment 2, Task 1 - Modify 'GM HUMMER Description' in table 'inventory'
UPDATE inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

-- Prompt 6 of Assigment 2, Task 1 -  UPDATE images path
